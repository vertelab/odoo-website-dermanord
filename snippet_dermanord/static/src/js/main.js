        ...
        openerp.jsonRpc("/category_snippet/get_p_categories", "call", {
            ...
            if (data['category_list'].length == 0) {
                ...
                $.each(data['category_list'], function(key, info) {
                    var content = '<a href="' + data['category_list'][key]['url'] + '"><div class="categ_block col-md-4 col-xs-12"><img class="img img-responsive categ_block_img" src="' + data['category_list'][key]['image'] + '"/><div class="container"><h2 class="categ_block_text dn_uppercase">' + '<span>' + data['category_list'][key]['name'] + '</span></h2></div></div></a>';

...
class blog_post_object(models.Model):
    ...
    object_id = fields.Reference(selection=[('product.template', 'Product Template'), ('product.product', 'Product Variant')],m2o=[],effektive_readonly=1,no_open=True,no_create=1, no_create_edit=1)

...
class ir_http(models.AbstractModel):
    ...
    def _handle_exception(self, exception, code=500):
        ...
        if not is_website_request:
            request.env['website.error.log'].log_error(request, None, 0, False)
            ...
            try:
                ...
                if isinstance(response, Exception):
                    ...
                    request.env['website.error.log'].log_error(request, response, 0, False)
            ...
            if isinstance(exception, werkzeug.exceptions.HTTPException) and code is None:
                ...
                request.env['website.error.log'].log_error(request, None, 0, values['traceback'])
                return exception
            ...
            request.env['website.error.log'].log_error(request, None, code, values['traceback'])
            try:
